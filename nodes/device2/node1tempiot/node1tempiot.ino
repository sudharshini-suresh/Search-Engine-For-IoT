...
const char* ssid = "**********";
const char* password = "**********";
String var1="0",var2="Galway",var3="0",var4="0",var5="0";
String recvalue;
int str_count;
 String s1;

const char* serverName = "https://iotdatadcu.com/IOTdevice2/iot2_data.php?pass=sudharshini";

const char* serverName1 = "https://iotdatadcu.com/IOTdevice2/iot2_data.php?pass=sudharshini";
...
void loop() {
  ...
  if ((millis() - lastTime) > timerDelay) {
    ...
    if(WiFi.status()== WL_CONNECTED){
      ...
      String httpRequestData = "humidity=" + var1 + "&location=" + var2; //+ "&gas=" + var3+ "&location=" + var4;//+ "&e=" + var5;           
