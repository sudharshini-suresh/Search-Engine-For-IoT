...
const char* ssid = "**********";
const char* password = "**********";
String var1="T",var2="G",var3="0",var4="DCU",var5="0";
String recvalue;
int str_count;
 String s1;

const char* serverName = "https://iotdatadcu.com/IOTdevice/iot_data.php?pass=sudharshini";

const char* serverName1 = "https://iotdatadcu.com/IOTdevice/iot_data.php?pass=sudharshini";
...
void loop() {
  ...
  Serial.print("gas sensor value is =");
  ...
  if ((millis() - lastTime) > timerDelay) {
    ...
    if(WiFi.status()== WL_CONNECTED){
      ...
      String httpRequestData = "temperature=" + var1 + "&humidity=" + var2+ "&gas=" + var3+ "&location=" + var4;//+ "&e=" + var5;           
