...
const char* serverName = "https://iotdatadcu.com/IOTdevice3/iot3_data.php?pass=sudharshini";

const char* serverName1 = "https://iotdatadcu.com/IOTdevice3/iot3_data.php?pass=sudharshini";
...
void loop() {
  ...
  if ((millis() - lastTime) > timerDelay) {
    ...
    if(WiFi.status()== WL_CONNECTED){
      ...
      String httpRequestData = "gas=" + var1 + "&location=" + var2;//+ "&gas=" + var3+ "&location=" + var4;//+ "&e=" + var5;           
